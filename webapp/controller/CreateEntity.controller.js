sap.ui.define([
	...
	return BaseController.extend("com.sap.hat.HATOfflineDemo.controller.CreateEntity", {
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("PurchaseOrders", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("PurchaseOrders", oData);
