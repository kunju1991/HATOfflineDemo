/*global history */
sap.ui.define([
	"com/sap/hat/HATOfflineDemo/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"com/sap/hat/HATOfflineDemo/model/formatter",
	"sap/m/MessageBox",
	"com/sap/hat/HATOfflineDemo/model/grouper",
	"com/sap/hat/HATOfflineDemo/model/GroupSortState"
], function (BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, MessageBox, grouper,
	GroupSortState) {
	"use strict";

	return BaseController.extend("com.sap.hat.HATOfflineDemo.controller.Master", {
		...
		onSearch: function (oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("POId", FilterOperator.Contains, sQuery)];
			} else {
		...
		onOpenViewSettings: function () {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("com.sap.hat.HATOfflineDemo.view.ViewSettingsDialog", this);
				...
				function (mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							POId: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("POId"))
						}, true);
					}
				}.bind(this),
				function (mParams) {
		...
		_showDetail: function (oItem) {
			...
			this.getRouter().navTo("object", {
				POId: encodeURIComponent(oItem.getBindingContext().getProperty("POId"))
			}, bReplace);
		},
