			...
			actions: {
							...
							this.waitFor({
								...
								success: function (oList) {
									...
									if (!aItemsNotInTheList.length) {
										...
										sCurrentId = aEntityData[aEntityData.length - 1].POId;
									} else {
										sCurrentId = aItemsNotInTheList[0].POId;
									}
				...
				iRememberTheListItem: function (oListItem) {
					...
					this.getContext().currentItem = {
						...
						title: oBindingContext.getProperty("POId")
					};
				},
			...
			assertions: {
				...
				theListHeaderDisplaysZeroHits: function () {
					return this.waitFor({
						...
						success: function () {
							Opa5.assert.ok(true, "The list header displays 'PurchaseOrders (0)'");
						},
				...
				theListShouldBeSortedAscendingOnName: function () {
					return this.theListShouldBeSortedAscendingOnField("POId");
				},
					...
					return this.waitFor({
						...
						success: function (oList) {
							...
							this.waitFor({
								...
								matchers: new PropertyStrictEquals({
									name: "title",
									value: "PurchaseOrders (" + iExpectedLength + ")"
								}),
								success: function () {
