sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/sap/hat/HATOfflineDemo/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#HATOfflineDemo-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#HATOfflineDemo-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("com.sap.hat.HATOfflineDemo.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/sap/hat/HATOfflineDemo/localService/mockserver"], function (mockserver) {
