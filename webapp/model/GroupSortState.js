sap.ui.define([
	...
	return BaseObject.extend("com.sap.hat.HATOfflineDemo.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias com.sap.hat.HATOfflineDemo.model.GroupSortState
		 */
		...
		/**
		 * Sorts by POId, or by GrossAmount
		 *
		...
		group: function (sKey) {
			...
			if (sKey === "GrossAmount") {
				...
				this._oViewModel.setProperty("/sortBy", "POId");
			}
